...
//
// 用法：
//   node slides/tools/apply-narration.js             # 全部章节 + 全部小节封面
//   node slides/tools/apply-narration.js chapter-05   # 仅第 5 章
//   node slides/tools/apply-narration.js unit-08      # 仅第 8 小节（封面）
//
// 说明：
...
function writeData(dataFile, slidesData) {
  const out = '// 由 slides/tools/generate.js 生成，旁白由 tools/apply-narration.js 合并\nwindow.SLIDES = ' + JSON.stringify(slidesData, null, 2) + ';\n';
